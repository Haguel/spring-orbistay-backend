-- Initial migration for the Booking clone database with updated names
-- Date: March 01, 2025
-- Notes: Incorporates table and column renames from the update migration; keeps 'app_user' as is.
